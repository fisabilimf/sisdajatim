          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                 {!! Form::model($jberita,['method' => 'PATCH','route'=>['databeritas.update',$jberita->id],'files'=>true]) !!}
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    <button type="submit" class="btn btn-primary">Ubah</button> <a class="btn btn-danger" href="{{url("databeritas")}}">Kembali</a>
                     <a class="btn btn-warning fancybox" href="#inline1">Hapus</a>
                       <div id="inline1" style="width:400px;display: none;">
                                                    ...
                                                    <br><br>
                                                    <a href="{{url('databeritas/destroy/'.$jberita->id)}}" class = "btn btn-success">Ya, Hapus Berita Ini</a>
                                              </div>
                  </div>
                 {!! Form::close() !!}
