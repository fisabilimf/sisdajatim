...
Kebijakan Pengelolaan Sumber Daya Air.</li>
                                ...
                                <section id="struktur" class="about" style="padding-bottom: 10px;">
                                    <div class="container" data-aos="fade-up">
                                        ...
                                        <div class="section-header">
                                            <!--<h2>Struktur Organisasi Dinas PU Sumber Daya Air Provinsi Jawa Timur</h2>-->
                                            <div style="text-align:justify;"><img src="{{asset('asset/dokumen/'.$struktur->foto)}}" alt="image" width="100%"></div>
                                        </div>
                                ...
                                <section id="struktur" class="about" style="padding-bottom: 10px;">
                                    <div class="container" data-aos="fade-up">
                                        ...
                                        <div class="section-header">
                                            <h2>Daftar UPT</h2>
                                            <iframe src="https://hidrologi.dpuair.jatimprov.go.id/mapview2" width="100%" height="800px" style="border:none;"></iframe>
                                        </div>
