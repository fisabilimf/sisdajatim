                ...
                <div class="col-lg-12 col-md-12">
                    <div class="latest_newsarea"> <span>PU SDA</span>
                        ...
                        <div class="social_area">
                            <ul class="social_nav">
                                <li class="twitter"><a href="https://twitter.com/pusdajatim"></a></li>
                                <li class="youtube"><a href="https://www.youtube.com/channel/UCN4azMMGetc5pXe97S0cSKw/videos?app=desktop"></a></li>
                                <li class="mail"><a href="https://www.instagram.com/pusdajatim/"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
