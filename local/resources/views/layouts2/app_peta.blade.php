...
<html>
<head>
<title>Dinas Pekerjaan Umum Dumber Daya Air</title>
...
<!--webfont-->
<!---pop-up-box----> 
<link href="{{asset("asset/main/css/popuo-box.css")}}" rel="stylesheet" type="text/css" media="all"/>
<script src="{{asset("asset/main/js/jquery.magnific-popup.js")}}" type="text/javascript"></script>
                ...
                <div class="header-left">
                    <div class="logo">
                          <a href="{{url("/")}}">
                            ...
                            <img src="{{asset("asset/main/images/gres.png")}}" style="width:80%" >
                        </div>
                            <div class="col-sm-9" style="padding:0">
                            <h6>Dinas Pekerjaan Umum Sumber Daya Air</h6>
                            <h1>Provinsi <span>Jawa Timur</span></h1>
                        </div>
                        </div>
                        </a>
                    </div>
                    ...
                    <div class="social-icons">
						...
						<form style="line-height:1.1" method="post" action="{{url('main/search_store')}}">
							<input type="text" style="width:100%;margin:0px" name="cari"/>
