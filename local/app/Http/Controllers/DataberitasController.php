...
class DataberitasController extends Controller
{
    //
         ...
         public function index()
    {
    	...
    	return view('databeritas.index',compact('data'));
    }
       public function create()
    {
    	$jenis = Jenis_beritas::where('del','=',0)->lists('name','id');
    	return view('databeritas.create',compact('jenis'));
    }
        ...
        public function edit($id)
    {
    	...
    	return view('databeritas.edit',compact('jberita','jenis'));
    }
   ...
   return redirect('databeritas');
     ...
     public function kotak()
    {
      ...
      return view('databeritas.kotak',compact('data'));
    }
     public function show($id)
    {
      $berita = Beritas::find($id);
      $data = Komentars::where('berita_id','=',$id)->where('del','=',0)->get();
      return view('databeritas.show',compact('data','berita'));
    }
}
