...
class MainController extends Controller
{
     ...
     public function berita_detail($data)
    {
     ...
     $head_data = Beritas::where('del','=',0)->where('jenis_berita_id','=',$data)->orderBy('tanggal','DESC')->orderBy('id','DESC')->paginate(4);
       $headline = array();
            ...
            return view('main.berita_detail',compact('data','headline','head_data'));
    }
  ...
  public function agenda()
    ...
    {
        $gallery = Beritas::where('del','=',0)->orderBy('tanggal','DESC')->OrderBy('id','DESC')->take('5')->get();
        $galleri = array();
    ...
    public function profil()
    {
        ...
        return view('main.profil',compact('profil','struktur','lingkup','sarana'));
    }
     ...
     public function detail($id)
    {
        ...
        return view('main.detail',compact("headline",'berita_biasa','berita_baru','komentar','komen_count'));
    }
